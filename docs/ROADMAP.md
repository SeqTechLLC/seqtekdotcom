...
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------ |
| C-1 | Testimonial re-collection with full attribution (target 12-15). Podcast/channel mining (2026-06-12) found 5 starting points: 3 on-tape leads (Kristy Boone ep 24, Ryan Campbell ep 9, Daniel Miller ep 10) + 2 published named-client workshop shorts (CPM `Rg5whZAqQYk`, Economasters CEO `MqBRl8hNiKU`) — see `../podcast/episodes/CLIP_CANDIDATES.md` §4                                                                                                                            | 🟡     | Content lead |
...
| C-4 | Founder video — cut from the SEQTEK Podcast Hank episode (2026-06-08, 48 min, 1080p at `../podcast/`). Four cuts ready: `founding-story.mp4` (~10 min), `faith-stewardship.mp4` (~5 min), plus website/social shorts in `../podcast/cuts/` (`seqtek-value-72s`, `seqtek-culture-45s`, with hand-cleaned SRTs + upload metadata in `cuts/README-upload.md`). Remaining: YouTube upload (needs channel access — Studio → Permissions invite) → wire videoIds into `VideoEmbed` on /about | 🟡     | Kenn         |

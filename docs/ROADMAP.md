...
**Status:** Phase 3 render foundation (spec 004) shipped (PR #21) and closed; marquee _content_ deferred to the content track (content-lead-gated). Spec 008 GTM code/doc track shipped (PR #31, P5-2) — external GTM-UI/staging config tail remains. Active engineering: deferred-tech follow-ups + Phase 5 polish.

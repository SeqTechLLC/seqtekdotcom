...
- Cost: one large migration (every old block table dropped) and a rewrite of the content JSON. Environments rebuild
  from the JSON rather than transforming data in place.

...
> Promoted from `specs/002-aws-cdk-infrastructure/contracts/` when the spec directories were retired.
> Kept because `INFRASTRUCTURE_QUICKSTART.md` §8 cites its rotation matrix.

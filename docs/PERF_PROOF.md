...
> Promoted from `specs/007-launch-hardening-polish/` when the spec directories were retired. This is the
> measured evidence behind the performance numbers in `ARCHITECTURE.md` §7, which are quoted externally.

...
const VALID_SLUGS = new Set(
  navigation.mainNav
    ...
    .filter((url) => url.startsWith('/services/'))
    .map((url) => url.replace('/services/', '')),
)
...
export default async function ServicePlaceholder({
  params,
}: {
  ...
  return (
    <main className="mx-auto max-w-container-md px-4 py-16 md:px-6 lg:px-8">
      ...
      <p className="mt-4 text-body-lg text-text-secondary">
        This service page is coming soon. In the meantime, see our{' '}

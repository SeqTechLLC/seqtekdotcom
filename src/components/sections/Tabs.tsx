  ...
  return (
    <section className="px-4 py-12 md:px-6 lg:px-8">
      <div className="mx-auto max-w-container-xl">
        {/* DESIGN_SYSTEM §11.4: the panel bodies are body copy at the full rail
            (~160ch at 1280 before this). The heading and the tab strip travel
            inside the same centred 65ch column, because capping only the panel
            would leave a full-width tablist over a narrower body — the
            mismatch the rule's heading clause names. */}

...
- [x] T048b [US4] `tests/e2e/admin/blockPicker.e2e.spec.ts` updated: it located the picker button by `/add layout/i`, and Payload builds that button's name from the field's own label, which T048 rewrote to "Page content".

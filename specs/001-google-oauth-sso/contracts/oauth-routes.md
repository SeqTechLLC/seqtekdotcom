...
| --- | ------ | -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| 1   | GET    | `/api/auth/oauth/authorization/google` | Browser entry. Redirects to Google's authorize endpoint with `client_id`, `redirect_uri`, `scope=openid email profile`, `state=<csrf>`, `hd=seqtechllc.com`, `prompt=select_account`.                                                                                                                                                                                                                                                               | 302          |

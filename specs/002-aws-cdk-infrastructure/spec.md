...
- **FR-003**: Network isolation MUST place the database, application instances, and any internal-only resources in private subnets, with only the load balancer in public subnets.

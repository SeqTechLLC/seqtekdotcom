...
`preview.seqtek.com` (UAT, primary Fargate lane); **publishing** the GitHub Release (Release-Please creates it as a draft)
...
branch. Both lanes sit behind an ALB + Cognito gate — the gate is index control, not access

...
- `docs/ARCHITECTURE.md` — system design, stack rationale, deployment, promotion model (`main` → preview/UAT at preview.seqtek.com; `vX.Y.Z` release → prod at ww3.seqtek.com)
